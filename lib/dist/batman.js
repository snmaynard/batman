  ...
  Batman.View = (function(_super) {
    ...
    View.prototype.applyYields = function() {
      ...
      return this.get('yields').forEach(function(name, nodes) {
        var action, node, yieldObject, _i, _len, _ref, _ref1, _ref2, _results;
        ...
        for (_i = 0, _len = nodes.length; _i < _len; _i++) {
          ...
          console.log((_ref1 = _this.get('node')) != null ? _ref1.innerHTML : void 0);
          _results.push(yieldObject[action](node, (_ref2 = _this.get('node')) != null ? _ref2.querySelector("[data-yield='" + name + "']") : void 0));
        }
        return _results;
      });
    };
...
(function() {
  ...
  Batman.DOM.Yield = Yield = (function(_super) {
    ...
    Yield.prototype.append = Yield.queued(function(node, parent) {
      if ((parent != null) && parent !== this.containerNode) {
